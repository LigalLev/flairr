...
import { ADD_GIG, ADD_TO_CART, CLEAR_CART, REMOVE_GIG, REMOVE_FROM_CART, SET_GIGS, UNDO_REMOVE_GIG, UPDATE_GIG, SET_FILTERBY, } from "./gig.reducer.js";
...
export function setFilterBy(filterBy) {
    store.dispatch({type: SET_FILTERBY, filterBy: filterBy})
    return 
}
