...
function _createGigs() {
    ...
    if (!gigs || !gigs.length)
        gigs = [{
            ...
            daysToMake: 3,
            description: "Hello, I am nadia. Welcome to my logo design gig. I specialize in business logo design. My design will be clean, trendy, minimal and original. \nI have successfully designed logos for many brands and now I am here on Fiverr to give the best. \nWhy Me? Original, minimal, unique, high quality logo designs Premium customer support 24 x 7 Unlimited revisions, until you are satisfied All types of vector and source files AI, JPEG, .PNG, PDF, EPS in high resolution WORKFLOW Precise and Strong Communication - Research on current trend - Sketching the initial concepts and Digitalizing it - Submission for Review - Modifications for making the design perfect Minimalist Logo | Minimal | Professional | Modern | Text | Vintage | Badge | Hand drawn | Feminine | Signature | Custom | Watercolor | YouTube Channel | Beauty. \nCustomer satisfaction is my top-notch priority and I believe in providing my customer with smooth and comfortable journey on Fiverr. Sounds interesting?? Lets chat!!!Order a gig now and lets have the ball rolling!!!!",
