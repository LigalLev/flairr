...
export function HomePageCarousel(props) {
    ...
    const imgUrls = popularServices.map(popularService => popularService.imgUrl)
                        ...
                        <div className="keen-slider__slide">
                            <div className="popular-services-container">
                                <div className="popular-services-txt">
                                    <div className="preTitle"> {ps.preTitle} </div>
                ...
                {loaded && instanceRef.current && (
                    <>
                        <Arrow
                            ...
                            left
                            onClick={(e) =>
                                e.stopPropagation() || instanceRef.current?.moveToIdx(currentSlide - 5)
                            }
                        />
                        <Arrow
                            direction={"right"}
                            onClick={(e) => {
                                return e.stopPropagation() || instanceRef.current?.moveToIdx(currentSlide + 5)
                            }}
                        />
                    </>
                )}
...
function Arrow(props) {
    ...
    return (
        <div onClick={props.onClick} className={className} style={{ scale: "1.5" }}>
            {arrowToShow}
